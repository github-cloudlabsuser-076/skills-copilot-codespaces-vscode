...
9. In the **Security** tab, configure the desired security settings for your virtual network.
...
12. Wait for the deployment to complete. Once the virtual network is created, you can start using it in your Azure resources.
